...
export const metadata: Metadata = {
  title: 'Privacy Policy &mdash; ZiggyDocs',
        ...
        <div className="mt-10 space-y-8 text-sm leading-relaxed text-[#b3b3b3]">
          ...
          <section>
            ...
            <p>
              ...
              mid-sized businesses across the United States, including <strong className="text-white">ZiggyDocs</strong>.
            </p>
            <p className="mt-3">
            ...
            <div className="space-y-3">
              <div>
                ...
                <p>You have the right to know what personal information we collect, to request deletion of your data,
                  ...
                  <a href="mailto:privacy@ziggytechventures.com" className="text-[#7c3aed] hover:underline">
      ...
      <footer className="border-t border-[#2d2d2d] px-8 py-5 mt-12">
        <div className="max-w-3xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <nav className="flex items-center gap-5">
            <Link href="/privacy" className="text-xs text-[#7c3aed]">Privacy Policy</Link>
            <Link href="/terms" className="text-xs text-[#b3b3b3]/60 hover:text-[#7c3aed] transition-colors">Terms of Service</Link>
            <Link href="/cookies" className="text-xs text-[#b3b3b3]/60 hover:text-[#7c3aed] transition-colors">Cookie Policy</Link>
          </nav>
        </div>
      </footer>
    </div>
