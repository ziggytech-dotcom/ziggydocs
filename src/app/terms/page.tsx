      ...
      <main className="max-w-3xl mx-auto px-8 py-12">
        ...
        <div className="mt-10 space-y-8 text-sm leading-relaxed text-[#b3b3b3]">
          ...
          <section>
            ...
            <p>
              When using ZiggyDocs communication features, you agree to comply with all
      ...
      <footer className="border-t border-[#2d2d2d] px-8 py-5 mt-12">
        <div className="max-w-3xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <nav className="flex items-center gap-5">
            <Link href="/privacy" className="text-xs text-[#b3b3b3]/60 hover:text-[#7c3aed] transition-colors">Privacy Policy</Link>
            <Link href="/terms" className="text-xs text-[#7c3aed]">Terms of Service</Link>
